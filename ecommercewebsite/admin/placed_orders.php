...
if (isset($_POST['update_payment'])) {
   ...
   $payment_status = isset($_POST['payment_status']) ? $_POST['payment_status'] : ''; // Check if payment_status is set
               ...
               <div class="box">
                  ...
                  <form action="" method="post">
                     ...
                     <select name="payment_status" class="select">
                        <option selected disabled>Select payment status</option> <!-- Removed '<?= $fetch_orders['payment_status']; ?>' -->
